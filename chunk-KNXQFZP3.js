import{Ga as P,j as Q,l as E,n as N,p as O,ta as q,ua as g,wa as A}from"./chunk-SFT2U5JN.js";import{Ab as D,Bb as F,Cb as f,Eb as m,Fb as y,Ga as o,Jb as j,Kb as S,Rb as z,Sa as b,T as v,Ta as C,U as h,Wa as $,Ya as r,Z as T,eb as i,ga as p,hb as k,ib as I,kc as B,ob as u,pb as d,qb as x,rb as M,sb as w,zb as l}from"./chunk-2NNAJRAH.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
